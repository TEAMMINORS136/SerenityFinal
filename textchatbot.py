        ...
        if user_input:
            ...
            try:
                completion = client.chat.completions.create(
                    model="gpt-3.5-turbo",
                    messages=[
                        {"role": "system", "content": "You are a mental health assistant. First, ensure to understand from user what type of tone and conversation style they want so you can adjust. \
Provide highly supportive and empathetic responses. Make responses brief and deeply connect with individual and engage them with leading questions. \
Ensure to help them with impactful responses not vague suggestions. Lead the user in the conversation, give leading questions, exercises to engage them!! "},
